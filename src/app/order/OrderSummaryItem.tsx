...
import withCurrency, { WithCurrencyProps } from '../locale/withCurrency';
...
const OrderSummaryItem: FunctionComponent<OrderSummaryItemProps & WithCurrencyProps> = ({
    ...
    console.log('productOptions', name, amount, amountAfterDiscount, productOptions, currency);
    return (
        <>
        ...
        { isSubscription() && <div className="subscription-info 30-days">
            ...
            </svg> Subscription option (sends every 30 days)*
            </div>
        }
        { !isSubscription() &&
