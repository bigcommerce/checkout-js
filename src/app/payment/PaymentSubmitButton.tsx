...
const PaymentSubmitButtonText: FunctionComponent<PaymentSubmitButtonTextProps & WithRecurlyProps> = memo(({ methodId, methodName, methodType, methodGateway, initialisationStrategyType, brandName }) => {
