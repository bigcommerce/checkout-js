...
describe('StaticAddress Component', () => {
    ...
    beforeEach(() => {
        ...
        jest.spyOn(checkoutState.data, 'getBillingCountries')
    ...
    it('renders component if required fields for billing address are not missing', () => {
        const container = mount(<StaticAddressTest
            { ...defaultProps }
            type={ AddressType.Billing }
        />);

        expect(checkoutState.data.getBillingAddressFields)
            .toHaveBeenCalled();

        expect(container.find('.address-line-1').text())
            .toContain(defaultProps.address.address1);
    });
    ...
    it('renders component if required fields for shipping address are not missing', () => {
        ...
        expect(checkoutState.data.getShippingAddressFields)
            .toHaveBeenCalled();
