...
describe('toCSSRule()', () => {
    it('converts to CSS rule', () => {
        ...
        expect(toCSSRule('.foobar', styles))
            .toEqual('.foobar {background-color: #fff; color: #000;}');
    });
    ...
    it('merges CSS styles', () => {
        ...
        expect(toCSSRule('.foobar', stylesA, stylesB))
            .toEqual('.foobar {background-color: #fff; color: #333; padding: 10px;}');
    });
});
