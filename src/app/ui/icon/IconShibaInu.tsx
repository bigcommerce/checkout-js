...
const IconShibaInu: FunctionComponent = () => (
    <svg aria-labelledby="iconShibaInuTitle" enableBackground="new 0 0 641.7 649" height="100" role="img" viewBox="0 0 641.7 649" width="100" xmlns="http://www.w3.org/2000/svg">
        <title id="iconShibaInuTitle">Shiba Inu</title>
        <g id="Group_938" transform="translate(-953.348 -232.003)">
            <g id="Group_931">
                <path
                    ...
                    c83-42.5,180.1-47.6,267-14.1c9.3,3.5,18.4,7.6,27.3,12L1423.2,289.1z" fill="#F00500" id="Path_8573"
                />
                <path
                    ...
                    C1600.7,541,1599.2,607.2,1578,668.4z" fill="#F00500" id="Path_8574"
                />
                <path
                    ...
                    c2.9-0.4,6.4-0.5,7.5,0c1.8,0.7,3.8,6,4.6,12.4C1448.9,531.2,1448.7,546.2,1448.2,548.9z" id="Path_8575"
                />
                <path
                    ...
                    c4.4,0,8.1,0.7,14.1,2.6c12.3,3.8,30.6,13,52.9,26.4c18.4,11,25.3,16.4,30.6,23.8C1211.1,573.5,1213.5,580,1212.6,582z" id="Path_8576"
                />
                <path
                    ...
                    C1351.6,720.7,1354.2,720.9,1354.2,721.2z" id="Path_8577"
                />
                <path
                    ...
                    c-1.8-0.6-3.6-1.3-5.3-2.1l-3-1.5v-5.7l26.6,0.1l26.6,0.1l0.1,2.7C1305.7,747.5,1305.8,747.4,1301.4,749.9z" id="Path_8578"
                />
            </g>
            <path
                ...
                c8.9,0,11.5,0.1,11.5,0.4C1354.2,721.4,1352.9,726.3,1351.4,731.9z" fill="#FFF" id="Path_8579"
            />
            <path d="M995,624.1c-6.3,0.9-10,1.9-10,1.9" fill="none" id="Path_8580" />
            <path d="M1560.1,627c0,0-3.2-0.7-8.9-1.3" fill="none" id="Path_8581" />
            <path
                ...
                c4.5,6.1,7.4,13.9,9,22.9c0,0,0,0,0,0c9.3,53.4-26.8,147-26.8,147C1476.1,416.2,1455.8,392.4,1431.6,373.2L1431.6,373.2z" fill="#FFA409" id="Path_8582"
            />
            <path d="M1377.6,343.2c-0.2,0.2-0.3,0.5-0.5,0.7" fill="none" id="Path_8583" />
            <path d="M1509.1,476.9c-0.5,1.4-0.7,2.1-0.7,2.1" fill="none" id="Path_8584" />
            <g id="Group_934">
                <g id="Group_933">
                    <g id="Group_932">
                        <path
                            d="M1518.1,296.1c-7.8-1-44.7-1.2-86.5,77.1l-0.2-0.1c-16.8-13.4-29.4-19.7-29.4-19.7
                            c66.1-76,107-80.2,107-80.2C1513.6,279.3,1516.5,287.1,1518.1,296.1z" fill="#FF9300" id="Path_8585"
                        />
                    </g>
                    <path
                        d="M1491.3,443.1c-15.2-27-35.4-50.7-59.7-69.9c41.8-78.3,78.6-78.1,86.5-77.1c0,0,0,0,0,0
                        C1527.4,349.6,1491.3,443.1,1491.3,443.1z" fill="#FF8300" id="Path_8586"
                    />
                    <path d="M1519.6,296.4c-0.5-0.1-1-0.2-1.5-0.3L1519.6,296.4z" fill="#FF8300" id="Path_8587" />
                </g>
            </g>
            <path d="M1175.1,347.1c-1-1.4-2.1-2.8-3.1-4.2" fill="none" id="Path_8588" />
            <path d="M1035,480.8c1.1,3.4,1.8,5.2,1.8,5.2" fill="none" id="Path_8589" />
            <g id="Group_937">
                <g id="Group_936">
                    <g id="Group_935">
                        <path
                            d="M1146.2,353.4c0,0-13,6.3-30.4,19.7c0,0-0.1,0.1-0.2,0.1c-43.3-78.4-81.4-78.1-89.6-77.1
                            c1.6-9,4.6-16.9,9.3-22.9C1035.4,273.2,1077.8,277.4,1146.2,353.4z" fill="#FF9300" id="Path_8590"
                        />
                    </g>
                    <path
                        d="M1115.7,373.2c-19,14.6-43.2,37.5-61.8,69.9c0,0-37.4-93.5-27.8-147c0,0,0,0,0,0
                        C1034.2,295.1,1072.4,294.9,1115.7,373.2z" fill="#FF8300" id="Path_8591"
                    />
                    <path d="M1026.1,296.1c-0.5,0.1-1.1,0.2-1.6,0.3L1026.1,296.1z" fill="#FF8300" id="Path_8592" />
                </g>
            </g>
            <path d="M1390.1,495c0,0-32,2-28-23s29-28,36-27s35,11,30,32s-12,17-16,18S1390.1,495,1390.1,495z" fill="#FFF" id="Path_8593" />
            <path d="M1154.1,495c0,0-32,2-28-23s29-28,36-27s35,11,30,32s-12,17-16,18S1154.1,495,1154.1,495z" fill="#FFF" id="Path_8594" />
        </g>
    </svg>
);

export default withIconContainer(IconShibaInu);
