...
const PrivacyPolicyCheckboxFieldLink: FunctionComponent<{ url: string; themeV2?: boolean }> = ({
  url,
  themeV2,
}) => (
  <CheckboxFormField
...
const PrivacyPolicyFieldset: FunctionComponent<{ url: string; themeV2?: boolean }> = ({
  url,
  themeV2,
}) => (
...
const PrivacyPolicyAutoConsent: FunctionComponent<{ url: string; themeV2?: boolean }> = ({
  url,
  themeV2,
}) => (
