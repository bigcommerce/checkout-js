...
describe('EmailLoginForm', () => {
  ...
  it('renders form', () => {
    ...
    expect(component.find('button[type="button"]').text()).toBe('Go Back');
  ...
  it('notifies when user submits form', async () => {
    ...
    const component = mount(<EmailLoginFormTest isOpen={ true } onSendLoginEmail={ handleSubmit } />);
  ...
  it('renders confirmation text if email has been requested', () => {
    ...
    expect(component.find('form a').at(0).text()).toBe('Resend the link');
