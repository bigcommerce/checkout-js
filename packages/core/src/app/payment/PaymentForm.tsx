    ...
    <Form className="checkout-form" testId="payment-form">
      ...
      <div className="form-actions">
        {shouldHidePaymentSubmitButton ? (
          ...
          <PaymentSubmitButton
            brandName={brandName}
            initialisationStrategyType={selectedMethod?.initializationStrategy?.type}
            isComplete={!!selectedMethod?.initializationData?.isComplete}
            isDisabled={shouldDisableSubmit}
            methodGateway={selectedMethod?.gateway}
...
const PaymentMethodSubmitButtonContainer: FunctionComponent = () => (
  <div className="submitButtonContainer" id="checkout-payment-continue" />
);
