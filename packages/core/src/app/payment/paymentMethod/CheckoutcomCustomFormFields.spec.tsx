...
import checkoutcomCustomFormFields, {ccDocumentField,
  HiddenInput,
  OptionButton,} from './CheckoutcomCustomFormFields';
import CreditCardPaymentMethod, {CreditCardPaymentMethodProps,
  CreditCardPaymentMethodValues,} from './CreditCardPaymentMethod';
  ...
  describe('Sepa form fieldset', () => {
    ...
    beforeEach(() => {
      component = mount(
        <CheckoutcomAPMsTest
          { ...sepaProps }
          cardFieldset={ <SepaFormFieldset debtor={ getBillingAddress() } method={ sepaProps.method } /> }
        />,
      );
    });
