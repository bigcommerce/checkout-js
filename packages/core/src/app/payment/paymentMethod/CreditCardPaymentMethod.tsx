...
import {configureCardValidator,
  getCreditCardValidationSchema,
  CreditCardFieldset,} from '../creditCard';
import {getInstrumentValidationSchema,
  isCardInstrument,
...
export type CreditCardPaymentMethodValues =
  | CreditCardFieldsetValues
  | CardInstrumentFieldsetValues
  | HostedCreditCardFieldsetValues
  | DocumentOnlyCustomFormFieldsetValues
...
export default connectFormik(
  withForm(withLanguage(withPayment(withCheckout(mapFromCheckoutProps)(CreditCardPaymentMethod)))),
);
