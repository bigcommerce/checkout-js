...
const SquareV2PaymentMethod: FunctionComponent<SquareV2PaymentMethodProps> = ({
        ...
        return (
            <div data-test="squarev2_dummy_form" style={ { display: 'none' } }>
                <div className="form-field">
                    <div className="form-label" id="labelDefault" />
                    <div className="form-input" id="inputDefault" />
                </div>
                <div className="form-field">
                    <div className="form-input form-input--focus" id="inputFocus" />
                </div>
                <div className="form-field form-field--error">
                    <div className="form-label" id="labelError" />
                    <div className="form-input" id="inputError" />
                </div>
            </div>
        );
    };
    ...
    const copyStylesFromDummyFormFiels = () => {
        const styleProps = [ 'backgroundColor', 'borderColor', 'borderRadius', 'borderWidth', 'color', 'fontSize', 'fontWeight' ];

        return {
            default: {
                label: getStylesFromElement('labelDefault', [ 'color' ]),
                input: getStylesFromElement('inputDefault', styleProps),
            },
            focus: {
                input: getStylesFromElement('inputFocus', difference(styleProps, ['borderRadius'])),
            },
            error: {
                label: getStylesFromElement('labelError', [ 'color' ]),
                input: getStylesFromElement('inputError', [ 'borderColor', 'borderWidth', 'color' ]),
            },
        };
    };
    const mapToSquareStyles = (styles: ReturnType<typeof copyStylesFromDummyFormFiels>) => {
        ...
        return {
            ...
            '.message-text': {
                color: styles.default.label.color,
            },
            '.message-icon': {
                color: styles.default.label.color,
            },
            '.message-text.is-error': {
                color: styles.error.label.color,
            },
    ...
    const initializeSquareV2Payment = useCallback(
        (options: PaymentInitializeOptions) =>
            initializePayment({
                ...
                squarev2: {
                    containerId,
                    style: mapToSquareStyles(copyStylesFromDummyFormFiels()),
                    onValidationChange,
                },
            }),
        [initializePayment]
