...
const getInitialValidationState = ({ shouldShowNumberField, method }: {shouldShowNumberField: boolean, method: string }) => {
...
const isFieldInvalid = (fieldKey: AdyenV2CardFields, fieldsValidation: FieldsValidation): boolean => !!fieldsValidation[fieldKey] && !fieldsValidation[fieldKey]?.valid;
...
const AdyenV2CardValidation: FunctionComponent<AdyenV2CardValidationProps> = ({
    ...
    const [ fieldsValidation, setFieldsValidation ] = useState<FieldsValidation>(getInitialValidationState({shouldShowNumberField, method: paymentMethod.method}));
    ...
    }, [getInitialValidationState, selectedInstrument, paymentContext, paymentMethod, shouldShowNumberField]);


    const showValidationIcon = (key: AdyenV2CardFields) => isFieldInvalid(key, fieldsValidation) && (
    ...
    return (
        <div>
            ...
            <div className="form-ccFields" id={ verificationFieldsContainerId }>
                { shouldShowNumberField && <div className={ classNames(
                    'form-field',
                    'form-field--ccNumber',
                ...
                >
                    ...
                    <div
                        className={ classNames(
                            ...
                            { 'adyen-checkout__input--error': isFieldInvalid(AdyenV2CardFields.CardNumber, fieldsValidation) }
                        ) }
                ...
                { paymentMethod.method === 'scheme' && <div className="form-field form-ccFields-field--ccCvv">
                    ...
                    <div
                        className={ classNames(
                            ...
                            'has-icon',
                            'adyen-checkout__input-wrapper',
                            { 'adyen-checkout__input--error': isFieldInvalid(AdyenV2CardFields.SecurityCode, fieldsValidation) }
                        ) }
                ...
                { paymentMethod.method === 'bcmc' && <div className="form-field form-field--ccExpiry">
                    ...
                    <div
                        className={ classNames(
                            ...
                            'has-icon',
                            'adyen-checkout__input-wrapper',
                            { 'adyen-checkout__input--error': isFieldInvalid(AdyenV2CardFields.ExpiryDate, fieldsValidation) }
                        ) }
