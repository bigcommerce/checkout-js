...
import ManageCardInstrumentsTable, {ManageAccountInstrumentsTableProps,} from './ManageAccountInstrumentsTable';
...
describe('ManageAccountInstrumentsTable', () => {
  ...
  it('renders instrument as row in table', () => {
    ...
    expect(component.find('[data-test="manage-instrument-accountExternalId"]').at(0).text()).toBe(
