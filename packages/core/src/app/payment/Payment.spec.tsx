...
describe('Payment', () => {
  ...
  beforeEach(() => {
    ...
    jest
      .spyOn(checkoutState.data, 'getOrder')
    ...
    jest
      .spyOn(checkoutState.data, 'getPaymentMethod')
  ...
  it('renders error modal if there is error when submitting order', () => {
    jest
      .spyOn(checkoutState.errors, 'getSubmitOrderError')
  ...
  it('renders error modal if there is error when finalizing order', () => {
    jest
      .spyOn(checkoutState.errors, 'getFinalizeOrderError')
