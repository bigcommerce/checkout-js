...
describe('withHostedCreditCardFieldset', () => {
          ...
          <PaymentContext.Provider value={ paymentContext }>
            <LocaleContext.Provider value={ localeContext }>
              <FormContext.Provider value={ formContext }>
                <Formik initialValues={ initialValues } onSubmit={ noop } render={ formikRender } />
  ...
  it('passes error messages from hosted form to Formik form', async () => {
    ...
    onValidate({
      ...
      errors: {
        ...
        cardName: [],
        cardNumber: [
          { fieldType: 'cardNumber', type: 'required', message: 'Card number is required' },
        ],
      },
    });
  ...
  it('highlights hosted field in focus', async () => {
    ...
    expect(container.find(HostedCreditCardFieldset).prop('focusedFieldType')).toBe('cardNumber');
  });
