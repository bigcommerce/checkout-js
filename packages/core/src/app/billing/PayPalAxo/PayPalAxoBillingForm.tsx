...
import PayPalAxoStaticBillingAddress from './PayPalAxoStaticBillingAddress';
...
class PayPalAxoBillingForm extends PureComponent<
            ...
            <Form autoComplete="on">
                {shouldRenderStaticAddress && billingAddress && (
                    <div className="form-fieldset">
                        <PayPalAxoStaticBillingAddress address={billingAddress} />
                    </div>
                )}
