...
export const AppliedGiftCertificates: FunctionComponent<{
  giftCertificates: AppliedGiftCertificateInfo[];
}> = ({ giftCertificates }) =>
  giftCertificates.map((giftCertificate) => (
    <div data-test="cart-gift-certificate" key={giftCertificate.code}>
