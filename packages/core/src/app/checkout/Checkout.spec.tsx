...
import {createEmbeddedCheckoutStylesheet,
  createEmbeddedCheckoutSupport,} from '../embeddedCheckout';
...
describe('Checkout', () => {
  ...
  it('does not render checkout step if not required', () => {
    ...
    expect(steps.findWhere((step) => step.prop('type') === CheckoutStepType.Shipping)).toHaveLength(
      0,
    );
  });
  ...
  describe('customer step', () => {
    ...
    it('navigates to next step when account is created', () => {
      ...
      // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
      (container.find(Customer).at(0) as ReactWrapper<CustomerProps>).prop('onAccountCreated')!();
    ...
    it('navigates to next step when shopper continues as guest', () => {
      ...
      // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
      (container.find(Customer).at(0) as ReactWrapper<CustomerProps>).prop('onContinueAsGuest')!();
    ...
    it('logs unhandled error', () => {
      ...
      // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
      (container.find(Customer).at(0) as ReactWrapper<CustomerProps>).prop('onUnhandledError')!(
        error,
      );
    ...
    it('logs error if shopper is unable to sign in', () => {
      ...
      // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
      (container.find(Customer).at(0) as ReactWrapper<CustomerProps>).prop('onSignInError')!(error);
  ...
  describe('shipping step', () => {
    ...
    it('renders multi-shipping when enabled and there are multiple consignments', async () => {
      jest
        .spyOn(checkoutState.data, 'getConsignments')
        .mockReturnValue([
    ...
    it('logs unhandled error', () => {
      ...
      (container.find(Shipping).at(0) as ReactWrapper<ShippingProps>).prop('onUnhandledError')(
        error,
      );
  ...
  describe('billing step', () => {
    ...
    it('logs unhandled error', () => {
      ...
      (container.find(Billing).at(0) as ReactWrapper<BillingProps>).prop('onUnhandledError')(error);
  ...
  describe('payment step', () => {
    ...
    it('posts message to parent of embedded checkout when there is order submission error', () => {
      ...
      // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
      (container.find(Payment).at(0) as ReactWrapper<PaymentProps>).prop('onSubmitError')!(error);
