...
describe('CheckoutStep', () => {
  ...
  it('scrolls to container when step is active', () => {
    ...
    const expectedPosition =
      component.getDOMNode().getBoundingClientRect().top + window.scrollY - window.innerHeight / 5;
  ...
  it('does not render suggestion if step is active', () => {
    const component = shallow(<CheckoutStep { ...defaultProps } suggestion="Billing suggestion" />);
