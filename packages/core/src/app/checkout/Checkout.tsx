...
import {CheckoutSuggestion,
  ...
  CustomerViewType,} from '../customer';
...
> {
  ...
  async componentDidMount(): Promise<void> {
    ...
    try {
      ...
      const buyNowCartFlag =
        data.getConfig()?.checkoutSettings.features['CHECKOUT-3190.enable_buy_now_cart'] ?? false;
  ...
  private renderCustomerStep(step: CheckoutStepStatus): ReactNode {
    ...
    const { customerViewType = isGuestEnabled ? CustomerViewType.Guest : CustomerViewType.Login } =
      this.state;
