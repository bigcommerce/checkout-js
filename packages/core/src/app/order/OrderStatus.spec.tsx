...
describe('OrderStatus', () => {
  ...
  describe('when order is complete', () => {
    it('renders confirmation message with contact email and phone number if both are provided', () => {
      const orderStatus = mount(<OrderStatusTest { ...defaultProps } supportPhoneNumber="990" />);
  ...
  describe('when order has mandate', () => {
    ...
    it('renders mandate link if it is provided', () => {
      ...
      expect(orderStatus.find('[data-test="order-confirmation-mandate-id-text"]')).toHaveLength(0);
    });
    ...
    it('renders mandate id if it is provided', () => {
      ...
      expect(orderStatus.find('[data-test="order-confirmation-mandate-link-text"]')).toHaveLength(
        0,
      );
      expect(orderStatus.find('[data-test="order-confirmation-mandate-id-text"]')).toHaveLength(1);
    });
    ...
    it('renders "SEPA Direct Debit Mandate" text on mandate link when provider description is Stripe (SEPA)', () => {
      ...
      expect(orderStatus.find('[data-test="order-confirmation-mandate-link-text"]').text()).toBe(
    ...
    it('renders "SEPA Direct Debit Mandate" text when provider description is Checkout.com', () => {
      ...
      expect(orderStatus.find('[data-test="order-confirmation-mandate-id-text"]').text()).toBe(
