...
describe('OrderSummaryTotal', () => {
    ...
    beforeEach(() => {
      orderSummaryTotal = mount(
        <LocaleContext.Provider value={ localeContext }>
          <OrderSummaryTotal orderAmount={ 100 } shopperCurrencyCode="USD" storeCurrencyCode="USD" />
  ...
  describe('when shopper has different currency as store', () => {
    beforeEach(() => {
      orderSummaryTotal = mount(
        <LocaleContext.Provider value={ localeContext }>
          <OrderSummaryTotal orderAmount={ 100 } shopperCurrencyCode="USD" storeCurrencyCode="EUR" />
        </LocaleContext.Provider>,
      );
    });
