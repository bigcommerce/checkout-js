...
const OrderSummaryItem: FunctionComponent<OrderSummaryItemProps & WithCurrencyProps & {checkoutDescriptionsLoading: boolean}> = (item) => {
    const {
        amount,
        amountAfterDiscount,
        image,
    ...
    return (
        <>
            ...
            { isSubscription(item) && <div className="subscription-info 30-days">
