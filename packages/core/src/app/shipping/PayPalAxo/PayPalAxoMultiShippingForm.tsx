...
class PayPalAxoMultiShippingForm extends PureComponent<
    PayPalAxoMultiShippingFormProps & WithLanguageProps & FormikProps<MultiShippingFormValues>,
    MultiShippingFormState
> {
    static getDerivedStateFromProps(
        { cart, consignments }: PayPalAxoMultiShippingFormProps,
...
export default withLanguage(
    withFormik<PayPalAxoMultiShippingFormProps & WithLanguageProps, MultiShippingFormValues>({
