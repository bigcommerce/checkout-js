...
class PayPalAxoShippingAddressForm extends Component<
    PayPalAxoShippingAddressFormProps & ConnectFormikProps<SingleShippingFormValues>
> {
    render(): ReactNode {
        const {
            addresses,
...
export default connectFormik(PayPalAxoShippingAddressForm);
