...
export interface PayPalAxoSingleShippingFormProps {
    ...
    onSubmit(values: PayPalAxoSingleShippingFormValues): void;
...
export interface PayPalAxoSingleShippingFormValues {
    billingSameAsShipping: boolean;
    shippingAddress?: AddressFormValues;
    orderComment: string;
}

interface PayPalAxoSingleShippingFormState {
...
class PayPalAxoSingleShippingForm extends PureComponent<
    PayPalAxoSingleShippingFormProps & WithLanguageProps & FormikProps<PayPalAxoSingleShippingFormValues>
> {
    static contextType = FormContext;

    state: PayPalAxoSingleShippingFormState = {
    ...
    constructor(
        props: PayPalAxoSingleShippingFormProps & WithLanguageProps & FormikProps<PayPalAxoSingleShippingFormValues>,
    ) {
        super(props);
...
export default withLanguage(
    withFormik<PayPalAxoSingleShippingFormProps & WithLanguageProps, PayPalAxoSingleShippingFormValues>({
        ...
        validationSchema: ({
            ...
            getFields,
            methodId,
        }: PayPalAxoSingleShippingFormProps & WithLanguageProps) =>
            methodId
                ? object({
