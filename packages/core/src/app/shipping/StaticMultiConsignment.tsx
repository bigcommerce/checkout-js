...
const StaticMultiConsignment: FunctionComponent<StaticMultiConsignmentProps> = ({
  ...
  return (
    <div className="staticMultiConsignment">
      <h3 className={classNames('staticMultiConsignment-header', { 'body-bold': themeV2 })}>
        <TranslatedString
      ...
      <div className="checkout-address--static">
        <p className={classNames('address-entry', { 'sub-text': themeV2 })}>
          <span className="first-name">{`${address.firstName} `}</span>
          <span className="family-name">{address.lastName}</span>
        </p>
        <div className="address-details">
          <p className={classNames('street-address address-entry', { 'sub-text': themeV2 })}>
          ...
          <div className="shippingOption shippingOption--alt shippingOption--selected">
            <StaticShippingOption
              ...
              shippingCostAfterDiscount={
                isShippingDiscountDisplayEnabled
                  ? getShippingCostAfterAutomaticDiscount(selectedShippingOption.cost, [
                      consignment,
                    ])
                  : undefined
              }
