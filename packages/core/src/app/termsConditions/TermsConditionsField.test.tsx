...
describe('TermsConditionsField', () => {
    ...
    render(
      <LocaleContext.Provider value={localeContext}>
        <Formik initialValues={initialValues} onSubmit={noop}>
          <TermsConditionsField name="terms" terms="Hello world" type={TermsConditionsType.Modal} />
        </Formik>
  ...
  it('renders terms and conditions checkbox with link if type is "text"', () => {
    render(
      <LocaleContext.Provider value={localeContext}>
        <Formik initialValues={initialValues} onSubmit={noop}>
          <TermsConditionsField name="terms" terms={terms} type={TermsConditionsType.TextArea} />
        </Formik>
      </LocaleContext.Provider>,
    );
  ...
  it('renders terms and conditions checkbox with link if type is "url"', () => {
    ...
    render(
      <LocaleContext.Provider value={localeContext}>
        <Formik initialValues={initialValues} onSubmit={noop}>
          <TermsConditionsField name="terms" type={TermsConditionsType.Link} url={termURL} />
        </Formik>
      </LocaleContext.Provider>,
    );
