...
// order to mock it.
jest.mock('./getCurrentScriptPath', () =>
    () => 'https://helloworld.com/assets/app.js'
);
...
describe('configurePublicPath()', () => {
    ...
    it('sets public path for Webpack if path is provided', () => {
        ...
        expect((global as any).__webpack_public_path__)
            .toEqual('https://foobar.com/assets/');
    });
    ...
    it('sets public path for Webpack using current script path if path is not provided', () => {
        ...
        expect((global as any).__webpack_public_path__)
            .toEqual('https://helloworld.com/assets/');
    });
});
