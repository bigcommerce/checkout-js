...
describe('Alert', () => {
  ...
  it('sets class name based on alert type', () => {
    ...
    expect(shallow(<Alert type={ AlertType.Success } />).hasClass('alertBox--success')).toBe(true);

    expect(shallow(<Alert type={ AlertType.Warning } />).hasClass('alertBox--warning')).toBe(true);
  });
