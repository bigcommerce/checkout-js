...
const IconEthereum: FunctionComponent = () => (
    <svg aria-labelledby="iconEthereumTitle" clipRule="evenodd" fillRule="evenodd" height="100" role="img" viewBox="0 0 784.37 1277.39" width="100" xmlns="http://www.w3.org/2000/svg">
