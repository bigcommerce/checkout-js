...
export default class EmbeddedCheckoutStyleParser {
  parse(styles: EmbeddedCheckoutStyles): string[] {
    ...
    if (styles.label) {
      ...
      rules.push(
        toCSSRule('.form-field--error .form-inlineMessage', styles.label, styles.label.error),
      );
    }
    ...
    if (styles.button) {
      ...
      rules.push(
        toCSSRule('.optimizedCheckout-buttonPrimary:active', styles.button, styles.button.active),
      );
      rules.push(
        toCSSRule('.optimizedCheckout-buttonPrimary:focus', styles.button, styles.button.focus),
      );
      rules.push(
        toCSSRule('.optimizedCheckout-buttonPrimary:hover', styles.button, styles.button.hover),
      );
      rules.push(
        toCSSRule(
    ...
    if (styles.select) {
      ...
      rules.push(
        toCSSRule('.optimizedCheckout-form-select:focus', styles.select, styles.select.focus),
      );
      rules.push(
        toCSSRule('.optimizedCheckout-form-select:hover', styles.select, styles.select.hover),
      );
      rules.push(
        toCSSRule(
    ...
    if (styles.checkbox) {
      ...
      rules.push(
        toCSSRule('.optimizedCheckout-form-checkbox:focus', styles.checkbox, styles.checkbox.focus),
      );
      rules.push(
        toCSSRule('.optimizedCheckout-form-checkbox:hover', styles.checkbox, styles.checkbox.hover),
      );
      rules.push(
        toCSSRule(
