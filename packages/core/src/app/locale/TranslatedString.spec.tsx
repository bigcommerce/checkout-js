...
describe('TranslatedString Component', () => {
    ...
    it('calls language.translate', () => {
        ...
        expect(localeContext.language.translate).toHaveBeenCalledWith('address.address_line_1_label', undefined);
    });
    ...
    it('calls language.translate with data when passed', () => {
        ...
        expect(localeContext.language.translate).toHaveBeenCalledWith('address.address_line_1_label', data);
    });
});
