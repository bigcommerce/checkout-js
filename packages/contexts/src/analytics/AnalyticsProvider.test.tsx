...
describe('AnalyticsProvider', () => {
  ...
  beforeEach(() => {
    ...
    jest
      .spyOn(CheckoutSdk, 'createBraintreeAnalyticTracker')
      .mockImplementation(() => braintreeAnalyticTracker);
    ...
    jest
      .spyOn(CheckoutSdk, 'createPayPalCommerceAnalyticTracker')
      .mockImplementation(() => paypalCommerceAnalyticTracker);
  });
  ...
  it('track customer suggestion initialization', () => {
    render(
      <TestComponent eventName="customerSuggestionInit" eventProps={[{ data: 'test data' }]} />,
    );
  ...
  it('track customer payment method executed', () => {
    ...
    expect(paypalCommerceAnalyticTracker.customerPaymentMethodExecuted).toHaveBeenCalledTimes(1);
  ...
  it('track selected payment method', () => {
    ...
    expect(braintreeAnalyticTracker.selectedPaymentMethod).toHaveBeenCalledWith('paypalcreditcard');
  ...
  it('track wallet button click', () => {
    ...
    expect(braintreeAnalyticTracker.walletButtonClick).toHaveBeenCalledWith('paypalwalletbutton');
