...
describe('ExtensionService', () => {
  ...
  beforeEach(() => {
    jest
      .spyOn(checkoutService, 'loadExtensions')
      .mockReturnValue(Promise.resolve(checkoutService.getState()));
    jest
      .spyOn(checkoutService, 'renderExtension')
      .mockReturnValue(Promise.resolve(checkoutService.getState()));
    jest.spyOn(checkoutService, 'handleExtensionCommand').mockReturnValue(commandHandlerRemover);
    jest.spyOn(checkoutService, 'handleExtensionQuery').mockReturnValue(queryHandlerRemover);
    jest.spyOn(checkoutService.getState().data, 'getExtensions').mockReturnValue(getExtensions());
    jest
      .spyOn(checkoutService.getState().data, 'getExtensionByRegion')
      .mockReturnValue(getExtensions()[0]);
