...
const getAPMProps = {
    sepa: () => ({
        ...
        method: {
            ...
            config: { cardCode: null, displayName: 'SEPA', isHostedFormEnabled: true },
    ...
    oxxo: () => ({
        ...
        method: {
            ...
            supportedCards: [],
            providesShippingAddress: false,
            config: { cardCode: null, displayName: 'Oxxo', isHostedFormEnabled: true },
            type: 'PAYMENT_TYPE_API',
            nonce: null,
    ...
    fawry: () => ({
        ...
        method: {
            ...
            supportedCards: [],
            providesShippingAddress: false,
            config: { cardCode: null, displayName: 'fawry', isHostedFormEnabled: true },
            type: 'PAYMENT_TYPE_API',
            nonce: null,
            initializationData: { gateway: 'checkoutcom' },
            clientToken: null,
