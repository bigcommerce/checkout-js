...
describe('CheckoutCustomFormFields', () => {
  ...
  describe('Sepa form fieldset', () => {
    ...
    it('should render the sepa fieldset', () => {
      render(
        <CheckoutcomAPMsTest
          {...sepaProps}
          cardFieldset={<SepaFormFieldset debtor={billingAddress} method={sepaProps.method} />}
        />,
      );
      expect(
  ...
  describe('Fawry', () => {
    ...
    it('Shopper is able to see Fawry Payment Method', () => {
      ...
      expect(
        screen.getByText(
          localeContext.language.translate('payment.checkoutcom_fawry_customer_mobile_label'),
        ),
      ).toBeInTheDocument();

      expect(
        screen.getByText(
          localeContext.language.translate('payment.checkoutcom_fawry_customer_email_label'),
        ),
      ).toBeInTheDocument();
    });
  });
