...
export type AdyenOptions = Record<string, AdyenCreditCardComponentOptions>;
    ...
    <FormContext.Provider value={formContextProps}>
      <LoadingOverlay hideContentWhenLoading isLoading={isLoading}>
        <AdyenV3Form
          ...
          shouldRenderAdditionalActionContentModal={shouldRenderAdditionalActionContentModal}
