...
import BigCommercePaymentsCreditBanner from './BigCommercePaymentsCreditBanner';

describe('BigCommercePaymentsCreditBanner', () => {
        ...
        BigCommercePaymentsCreditBannerTest = () => (
            <CheckoutProvider checkoutService={checkoutService}>
                <LocaleContext.Provider value={localeContext}>
                    <BigCommercePaymentsCreditBanner {...defaultProps} />
    ...
    it('initializes BigCommercePaymentsCreditBanner', () => {
    ...
    it('catches error during BigCommercePaymentsCreditBanner initialization', () => {
