                    ...
                    <div className="vcard checkout-address--static">
                        ...
                        <div className="adr">
                            ...
                            <p className="address-entry">
                                ...
                                {/* FIXME: we should use localized address instead */}
                                {address.stateOrProvince && (
                                    <span className="region">{`${address.stateOrProvince}, `}</span>
                                )}
                                {/* TODO: */}
