...
const isBraintreeAchFormFieldName = (fieldName: string): fieldName is BraintreeAchFieldType =>
  Object.values(BraintreeAchFieldType).includes(fieldName as BraintreeAchFieldType);
...
const getTranslatedLabelByFieldName = (fieldName: string, language: LanguageService) => {
  ...
  return isBraintreeAchFormFieldName(fieldName) ? braintreeAchFormLabelsMap[fieldName] : fieldName;
};
