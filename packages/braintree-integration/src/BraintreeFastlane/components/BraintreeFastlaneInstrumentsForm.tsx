...
> = ({ onChange, handleSelectInstrument, selectedInstrument }) => {
  ...
  return (
    <div className="braintree-fastlane-instrument" data-test="braintree-fastlane-instrument-form">
      <div>
        <div className="braintree-fastlane-instrument-details">
          <CreditCardIcon cardType={cardType} />

          <div className="instrumentSelect-card" data-test="braintree-fastlane-instrument-last4">
            {/* &#9679; is a ● */}
