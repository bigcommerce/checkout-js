      ...
      await checkoutService.initializePayment({
        ...
        braintreefastlane: {
          ...
          onChange: (showPayPalCardSelector) => {
            paypalFastlaneComponentRef.current.showPayPalCardSelector = showPayPalCardSelector;
          },
          onError: (error: Error) => {
    ...
    <FormContext.Provider value={formContextProps}>
      <LoadingOverlay hideContentWhenLoading isLoading={isLoading}>
        <BraintreeFastlaneForm
          renderPayPalCardComponent={paypalFastlaneComponentRef?.current?.renderPayPalCardComponent}
          showPayPalCardSelector={paypalFastlaneComponentRef.current?.showPayPalCardSelector}
        />
      </LoadingOverlay>
