...
const StripeUPEPaymentMethod: FunctionComponent<PaymentMethodProps> = ({
  ...
  const { hidePaymentSubmitButton, disableSubmit, setFieldValue, setSubmit, setValidationSchema } =
    paymentForm;
  ...
  const initializeStripePayment = useCallback(
    ...
    [checkoutService, containerId, onUnhandledError, method, paymentContext, renderSubmitButton],
  );
