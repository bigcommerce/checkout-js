        ...
        expect(initializePayment).toHaveBeenCalledWith({
            ...
            stripeupe: {
                ...
                style: {
                    ...
                    fieldBorder: '',
                    fieldErrorText: 'canvastext',
                    fieldInnerShadow: '',
                    fieldPlaceholderText: 'canvastext',
                    fieldText: 'canvastext',
            ...
            expect.objectContaining({
                ...
                [`${method.gateway}`]: {
                    ...
                    style: {
                        fieldBackground: 'rgba(0, 0, 0, 0)',
                        fieldBorder: 'blue',
                        fieldErrorText: 'rgb(255, 0, 0)',
                        fieldInnerShadow: 'boxShadow',
                        fieldPlaceholderText: 'rgb(255, 0, 0)',
                        fieldText: 'rgb(255, 0, 0)',
                        labelText: 'rgb(255, 0, 0)',
                    },
                    onError: expect.any(Function),
                    render: expect.any(Function),
                },
