...
const HostedWidgetPaymentComponent = ({
  ...
  const getSelectedBankAccountInstrument = useCallback(
    (
      ...
      !addingNew && isBankAccountInstrument(currentSelectedInstrument)
  ...
  const accountInstruments: AccountInstrument[] = instruments.filter((i): i is AccountInstrument =>
    isBankAccountInstrument(i),
  );
      ...
      <div className="paymentMethod--hosted">
        ...
        {isInstrumentFeatureAvailableProp && (
          <StoreInstrumentFieldset
            ...
            isAccountInstrument={Boolean(isAccountInstrument || shouldShowAccountInstrument)}
          />
        )}
