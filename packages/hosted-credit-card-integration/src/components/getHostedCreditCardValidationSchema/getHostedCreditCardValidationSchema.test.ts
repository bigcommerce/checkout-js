...
import { type HostedCreditCardFieldsetValues } from '../../types';

import { getHostedCreditCardValidationSchema } from '.';
...
describe('getHostedCreditCardValidationSchema', () => {
  ...
  it('throws error if card name field is missing', () => {
    ...
    expect(() => schema.validateSync(values)).toThrow('payment.credit_card_name_required_error');
  });
