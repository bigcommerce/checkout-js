...
const Modal: FunctionComponent<ModalProps> = ({
  ...
  return (
    <ReactModal
      ...
      className={{
        base: classNames('modal optimizedCheckout-contentPrimary', additionalModalClassName),
    ...
    >
      <div className={classNames('modal-header', additionalHeaderClassName)}>
        ...
        {shouldShowCloseButton && (
          ...
          >
            {Boolean(closeButtonLabel) && <span className="is-srOnly">{closeButtonLabel}</span>}
      ...
      <div className={classNames('modal-body', additionalBodyClassName)} data-test="modal-body">
        {children}
      </div>
