...
const instrumentTypeMap: Record<string, InstrumentComponent> = {
  ...
  BITCOIN_CASH: {
    ...
    component: lazy(() => import(/* webpackChunkName: "icon-bitcoin-cash" */ './IconBitCoinCash')),
  },
  BANCONTACT: {
  ...
  CARNET: {
    instrument: 'carnet',
    component: lazy(() => import(/* webpackChunkName: "icon-card-carnet" */ './IconCardCarnet')),
  },
  CB: {
    instrument: 'cb',
  ...
  DANKORT: {
    instrument: 'dankort',
    component: lazy(() => import(/* webpackChunkName: "icon-card-dankort" */ './IconCardDankort')),
  },
  DISCOVER: {
    instrument: 'discover',
    component: lazy(
  ...
  MAESTRO: {
    instrument: 'maestro',
    component: lazy(() => import(/* webpackChunkName: "icon-card-maestro" */ './IconCardMaestro')),
  },
  MC: {
