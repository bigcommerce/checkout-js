...
### [1.374.1-prerelease.1695983532853](https://github.com/bigcommerce/checkout-js/compare/v1.374.1-prerelease.1695977192363...v1.374.1-prerelease.1695983532853) (2023-09-29)
...
* **checkout:** CHECKOUT-4223 Add checkout component ([44b8944](https://github.com/bigcommerce/checkout-js/commit/44b8944b27fe88b81885ebf253b8ae153421ef8c))
...
* **common:** CHECKOUT-4223 Add locale context provider ([9511bcd](https://github.com/bigcommerce/checkout-js/commit/9511bcd2cbd72c604412f788aba00f7336d2680e))
...
* **embedded-checkout:** CHECKOUT-4223 Add support for Embedded Checkout ([a5b6cf8](https://github.com/bigcommerce/checkout-js/commit/a5b6cf8a51408a30c97530b02bafe4e731f67244))
...
* **payment:** PAYMENTS-7524 Bump checkout-sdk version to 1.254.0 ([161a8ea](https://github.com/bigcommerce/checkout-js/commit/161a8ea51eb8ca58dac20e7194fef69319f0a1d0))
...
* **payment:** PAYPAL-2730 added execution method call after sign in customer for BraintreeAcceleratedCheckout payment method ([#1447](https://github.com/bigcommerce/checkout-js/issues/1447)) ([5022f39](https://github.com/bigcommerce/checkout-js/commit/5022f3954d07e215e9739d380f47438ef26b8400))
...
* **payment:** PAYPAL-2758 banner in Paywall  ([#1395](https://github.com/bigcommerce/checkout-js/issues/1395)) ([cabaf70](https://github.com/bigcommerce/checkout-js/commit/cabaf70364fc79e188306b5f2488e2115ea99ea1))
...
* **payment:** PAYPAL-2947 bump checkout-sdk-js ([638beb4](https://github.com/bigcommerce/checkout-js/commit/638beb4f9e19a2e9d88021d6bc21cf090b72fcae))
...
* **shipping:** CHECKOUT-4223 Add function for determining whether shopper is using multi-shipping ([fed94b3](https://github.com/bigcommerce/checkout-js/commit/fed94b31144ee2cf9a75a0593b7ae118a957b8c3))
* **shipping:** CHECKOUT-4223 Add Shipping form ([601a939](https://github.com/bigcommerce/checkout-js/commit/601a93999f8b1f7720ed88390e2e0e28203295c9))
* **shipping:** CHECKOUT-4223 Add shipping util functions ([ef1655e](https://github.com/bigcommerce/checkout-js/commit/ef1655e88c37692f6b4f6230422817adfb2f4ca2))
...
* **billing:** CHECKOUT-4352 Display special message in billing section when using Amazon Pay ([424b9c0](https://github.com/bigcommerce/checkout-js/commit/424b9c09ac812a4b395b372216efcb3ade86f3b8))
* **billing:** CHECKOUT-4352 Fix billing address not displaying properly when it is partially complete ([7ac4b42](https://github.com/bigcommerce/checkout-js/commit/7ac4b424a7be7e694cd84c4671f7698254582143))
* **billing:** CHECKOUT-4352 Keep the loading spinner spinning when updating order comment and billing address ([f1f161e](https://github.com/bigcommerce/checkout-js/commit/f1f161e3095d8d1083e78c84104d0112e69ee172))
...
* **cart:** CHECKOUT-4272 Fix spacing issue in cart summary panel ([51be22b](https://github.com/bigcommerce/checkout-js/commit/51be22be26577b4665737456d7085a619a17ae17))
* **cart:** CHECKOUT-4315 Do not strike-through amount without tax ([4f74825](https://github.com/bigcommerce/checkout-js/commit/4f74825650072b9818fce5605e84b86304800b5a))
...
* **checkout:** ADYEN-544 fixed adyen 3ds render error ([6c49611](https://github.com/bigcommerce/checkout-js/commit/6c49611f3954115dc36a7178efdc85f588177dec))
...
* **checkout:** CHECKOUT-4321 Bump checkout-sdk version to v1.32.1 ([2737c71](https://github.com/bigcommerce/checkout-js/commit/2737c71f52cfee936549f5185fcd264c6a07eaea))
* **checkout:** CHECKOUT-4344 Fix checkout steps not collapsing in mobile view ([a81a67a](https://github.com/bigcommerce/checkout-js/commit/a81a67ab0321eb52a07bedbe924d0247d6458f2a))
...
* **checkout:** INT-1829 INT-1836 CHECKOUT-4272 Bump checkout-sdk version to v1.34.1 ([4c8f395](https://github.com/bigcommerce/checkout-js/commit/4c8f395dd371a942c7c0967522417e195a43d525))
* **checkout:** INT-1902 Bump `checkout-js` version ([64ae4fe](https://github.com/bigcommerce/checkout-js/commit/64ae4fe40bfd85c6f4a1fd4425202f20ac2d2822))
...
* **checkout:** PI-122 fixed localisation for bluesnap direct ECP and Local Bank Transfer ([23c1bbe](https://github.com/bigcommerce/checkout-js/commit/23c1bbe1bc9490254bf430c3371e603ee783fdbd))
...
* **checkout:** PI-657 fixed validation for stored bluesnap direct card verification fields ([d66222e](https://github.com/bigcommerce/checkout-js/commit/d66222e5ad6870cd2a18f9322f7cf0cd9699a395))
...
* **common:** CHECKOUT-4307 Include polyfills for 3rd party dependencies ([7e103d6](https://github.com/bigcommerce/checkout-js/commit/7e103d64271966e792e46f237e11fd4d8886b7af))
* **common:** CHECKOUT-4336 Allow empty date custom field when optional ([13f1a98](https://github.com/bigcommerce/checkout-js/commit/13f1a982a630b946d3feff6f246d41b7c564c898))
* **common:** CHECKOUT-4336 Allow empty date custom field when optional ([3e2401c](https://github.com/bigcommerce/checkout-js/commit/3e2401c8e88995dbcd4fc060a74b4964a22d4b4e))
...
* **common:** CHECKOUT-4340 Use local timezone for date ranges ([dc6cac2](https://github.com/bigcommerce/checkout-js/commit/dc6cac2c291cf7ebfc2bb862ddd6361918e47e16))
* **common:** CHECKOUT-4364 Upgrade checkout-sdk version to v1.34.2 ([81303ea](https://github.com/bigcommerce/checkout-js/commit/81303ea5e56a1ed63fa3e9ceba78a99a90aa4e81))
* **common:** CHECKOUT-4374 Check out tag before uploading artifacts to Sentry ([53e179b](https://github.com/bigcommerce/checkout-js/commit/53e179b7f3b5f6b18d626f0de935803ec0f6fcd3))
* **common:** CHECKOUT-4374 Output polyfill as separate chunk ([3cc12ea](https://github.com/bigcommerce/checkout-js/commit/3cc12eadc4eafb72bee7d35a077bfca2ad2583e2))
* **common:** CHECKOUT-4374 Pass public path from host page ([6608bf0](https://github.com/bigcommerce/checkout-js/commit/6608bf0f1b01abe49eca4afabc205728a4154ce6))
* **common:** CHECKOUT-4374 Remove version prefix from Sentry release name ([d7725e1](https://github.com/bigcommerce/checkout-js/commit/d7725e13579ff850b252a5cf78837d275c465300))
* **common:** CHECKOUT-4409 Configure public path before rendering apps ([24504f6](https://github.com/bigcommerce/checkout-js/commit/24504f609235c3f96372f2b262460b6231c154f6))
* **common:** CHECKOUT-4412 Display fallback component if unable to lazy load chunk ([0cb677f](https://github.com/bigcommerce/checkout-js/commit/0cb677fe36f5bd1831e159d6e5e2c20e3ecfc14d))
* **common:** CHECKOUT-4412 Retry if unable to load asset chunk ([f253041](https://github.com/bigcommerce/checkout-js/commit/f2530417fc103d4ed61e578b60e672be44c5917b))
...
* **common:** CHECKOUT-4418 Rewrite filename of error frames before sending to Sentry ([ff05b2e](https://github.com/bigcommerce/checkout-js/commit/ff05b2ed2738f9853fba2adcb1a8d5f61b29b8d6))
...
* **common:** CHECKOUT-6674 Fix issue with alpha prerelease ([#908](https://github.com/bigcommerce/checkout-js/issues/908)) ([ecaf1f2](https://github.com/bigcommerce/checkout-js/commit/ecaf1f2b735c848350be0db0c9a3def201677903))
* **common:** CHECKOUT-6674 Fix issue with prerelease ([#904](https://github.com/bigcommerce/checkout-js/issues/904)) ([cdc603e](https://github.com/bigcommerce/checkout-js/commit/cdc603e70f6544373eae38fbde99b2c966458097))
...
* **customer:** CHECKOUT-4712 Do not send consent if not required ([1d9fcb5](https://github.com/bigcommerce/checkout-js/commit/1d9fcb578622eba22a13d1903ac909e02ae0c8f7))
...
* **embedded-checkout:** CHECKOUT-4388 Upgrade checkout-sdk version to v1.34.3 ([cac71db](https://github.com/bigcommerce/checkout-js/commit/cac71dbc1de94746dc38b26879167b06a83bea46))
* **order:** CHECKOUT-4355 Fix display issue of pick list items ([#1446](https://github.com/bigcommerce/checkout-js/issues/1446)) ([78d7581](https://github.com/bigcommerce/checkout-js/commit/78d7581064825b6d46e35c29e946ce3bcffcb119))
* **order:** CHECKOUT-4393 Bump SDK to fix order resubmission. ([decc29a](https://github.com/bigcommerce/checkout-js/commit/decc29a64e09ae1147f0784c76a43387695cf018))
...
* **payment:** CHECKOUT-4357 Redirect to PayPal when location header ([315fcca](https://github.com/bigcommerce/checkout-js/commit/315fcca9dc238ab709d1b83129b7d44744e00ab4))
* **payment:** CHECKOUT-4384 Fix payment form not hiding previous validation result when switching to new payment method ([1c5691f](https://github.com/bigcommerce/checkout-js/commit/1c5691f6164585d87fb094a890a057659feb1fe4))
* **payment:** CHECKOUT-4384 Reset payment form before mounting new payment method component ([03aa684](https://github.com/bigcommerce/checkout-js/commit/03aa68413dbfb9925cdec01c4f1fbf8008961d59))
* **payment:** CHECKOUT-4398 Prevent default when sign in to visa ([ae21ef5](https://github.com/bigcommerce/checkout-js/commit/ae21ef5ef8e20d09e89c55a71a2f781c055a371c))
...
* **payment:** INT-1831 widget is now loaded when vaulted instruments exists ([69ba28c](https://github.com/bigcommerce/checkout-js/commit/69ba28cbbd56890076d386c87ba86d47243946c5))
* **payment:** INT-1837 Fix conflicting styles injected by Klarna causing modal to be cropped in Firefox ([4b4b1fc](https://github.com/bigcommerce/checkout-js/commit/4b4b1fc010ee85baca3d210dcb68cec8c397f4d9))
...
* **payment:** INT-2595 Removed credit card fields in Adyen v1 using Paypal ([7caae80](https://github.com/bigcommerce/checkout-js/commit/7caae80ebb1c7e079a16d53de8124bbab1c38bab))
...
* **payment:** PAYPAL-0000 warnings fix ([311d0f1](https://github.com/bigcommerce/checkout-js/commit/311d0f13a624968a0196d8ce012ff3a13246bc45))
...
* **payment:** PAYPAL-2729 added some tests + refactoring and changed the disable button state logic in login form ([#1470](https://github.com/bigcommerce/checkout-js/issues/1470)) ([b655830](https://github.com/bigcommerce/checkout-js/commit/b6558301fd36edc0bb4d5067b15851baff4345fe))
...
* **payments:** INT-1892 Do not prompt when been redirected to 3DS1 using Converge ([d984fce](https://github.com/bigcommerce/checkout-js/commit/d984fce14b0e4a303468f6bd476055d4f5ed982b))
...
* **billing:** CHECKOUT-4272 Check if props are different before calling render method of billing components ([dcb3965](https://github.com/bigcommerce/checkout-js/commit/dcb3965ea7815a55a50a0eaa7fe844f92f01c213))
* **billing:** CHECKOUT-4272 Stop passing arrow functions into components in billing address components ([6658efe](https://github.com/bigcommerce/checkout-js/commit/6658efe9d28d7400f1acc001e654c8c5e799b78e))
* **billing:** CHECKOUT-4352 Optimize rendering of static address ([dab9d1c](https://github.com/bigcommerce/checkout-js/commit/dab9d1c494705112151ae26e9cb3080eee54038c))
* **billing:** CHECKOUT-4352 Optimize rendering of static address ([5ecdd35](https://github.com/bigcommerce/checkout-js/commit/5ecdd3595f977489dac9ace7bff797f69b8faddf))
* **cart:** CHECKOUT-4272 Avoid passing arrow function to cart components ([0036c08](https://github.com/bigcommerce/checkout-js/commit/0036c08771f822820d0c511843d6ca48280429dd))
* **cart:** CHECKOUT-4272 Check if props are different before calling render method of cart components ([d396b54](https://github.com/bigcommerce/checkout-js/commit/d396b54e862501903c51fccd21c82004ba8e91b3))
* **checkout:** CHECKOUT-4272 Avoid passing arrow function to checkout components ([6e037c0](https://github.com/bigcommerce/checkout-js/commit/6e037c016f060c962603bfa72fdf4b5d31b8ab19))
* **checkout:** CHECKOUT-4272 Check if props are different before calling render method of cart components ([587ed2a](https://github.com/bigcommerce/checkout-js/commit/587ed2ad3677b71fdf9fa01e42f3045c577f31b8))
* **checkout:** CHECKOUT-4338 Lazy load checkout steps using dynamic imports ([42522ab](https://github.com/bigcommerce/checkout-js/commit/42522abd7ca82aa4a51950491809c704f177787f))
* **checkout:** CHECKOUT-4338 Only load cart and order summary drawer when in mobile view ([35a0560](https://github.com/bigcommerce/checkout-js/commit/35a0560bf06ea3ba919ba117b71af36f9828a272))
* **common:** CHECKOUT-4223 Add custom Formik connector which shallow-checks injected props ([7550d6f](https://github.com/bigcommerce/checkout-js/commit/7550d6f0669de52125a8faaff18cbff870a76ac3))
* **customer:** CHECKOUT-4272 Check if props are different before calling render method of customer components ([01e2ad7](https://github.com/bigcommerce/checkout-js/commit/01e2ad73717d950ab29daa2262e2f066bd8d9c6d))
* **customer:** CHECKOUT-4272 Stop passing arrow functions into components in customer section ([caf3a83](https://github.com/bigcommerce/checkout-js/commit/caf3a8348e5523c6e4a5c407412c7babadc5f955))
...
* **order:** CHECKOUT-4272 Check if props are different before calling render method of order components ([534da6f](https://github.com/bigcommerce/checkout-js/commit/534da6f584eb96151d05f71913660cabdb889a83))
* **order:** CHECKOUT-4272 Stop passing arrow functions into components on order confirmation page ([76e7ea3](https://github.com/bigcommerce/checkout-js/commit/76e7ea31282cb6380687c4cc7861546e6a31f0d8))
* **payment:** CHECKOUT-4272 Avoid passing arrow function to credit card fields ([787bfd3](https://github.com/bigcommerce/checkout-js/commit/787bfd3e73cc8760ee0b8baa95ccda5996196652))
* **payment:** CHECKOUT-4272 Avoid passing arrow function to instrument fields ([33ee337](https://github.com/bigcommerce/checkout-js/commit/33ee3373db224a7ef91ae1860b8cead41489ad5f))
* **payment:** CHECKOUT-4272 Avoid passing arrow function to terms and condition field ([e455c06](https://github.com/bigcommerce/checkout-js/commit/e455c06d40b8c8b206c10a218d3dd92e312f7a11))
* **payment:** CHECKOUT-4272 Avoid re-rendering list of payment methods unless there are relevant changes ([624fe81](https://github.com/bigcommerce/checkout-js/commit/624fe81cf126b6d941c741caaba598d6e8b9ce4e))
* **payment:** CHECKOUT-4272 Avoid re-rendering payment method component unless there are relevant changes ([74803ff](https://github.com/bigcommerce/checkout-js/commit/74803ff4cb2db2556ced0b5ca5160b9f58f65a10))
* **payment:** CHECKOUT-4272 Check if props are different before calling render method of payment components ([e656647](https://github.com/bigcommerce/checkout-js/commit/e656647b471fcc259eed43c7b701ed209b9fe27b))
* **payment:** CHECKOUT-4272 Stop passing initialisation state to submit button of payment form ([39a83ec](https://github.com/bigcommerce/checkout-js/commit/39a83ec7096412c897cf8f96523b19cfb0e7247c))
* **shipping:** CHECKOUT-4272 Check if props are different before calling render method of shipping components ([2af27c8](https://github.com/bigcommerce/checkout-js/commit/2af27c81b7503888cc67a3f5ba66c97f5c274b3f))
* **shipping:** CHECKOUT-4272 Stop passing arrow functions into components in shipping components ([4d163d9](https://github.com/bigcommerce/checkout-js/commit/4d163d9e80c51e0d8b5dcaa1838489050419f056))
...
* **checkout:** CHECKOUT-4223 Ensure there is only one instance of `CheckoutService` and it is created at the root of the application ([3905f16](https://github.com/bigcommerce/checkout-js/commit/3905f1637d8d4f0977bc2ca189c874dde05e218d))
* **checkout:** CHECKOUT-4223 Rename exported render methods ([2e99512](https://github.com/bigcommerce/checkout-js/commit/2e995127f805e1942f2bee779f7a197892789438))
* **checkout:** CHECKOUT-4338 Use media query component to conditionally render checkout step ([d352673](https://github.com/bigcommerce/checkout-js/commit/d352673d2842c30ae4a496f05dc6ae2b7b0d0a93))
* **checkout:** CHECKOUT-4344 Remove temporary code required for transition period ([99388b3](https://github.com/bigcommerce/checkout-js/commit/99388b30802e1bb20bcf41d7809e5f1eeedae9ab))
...
* **checkout:** CHECKOUT-6891 Update incomplete order wording on order confirmation page ([1b3a5b6](https://github.com/bigcommerce/checkout-js/commit/1b3a5b64e97499a3c810f5e2c91d5dacfebc4abe))
* **checkout:** CHECKOUT-6891 update title wording for incomplete order ([8a6c3d6](https://github.com/bigcommerce/checkout-js/commit/8a6c3d6a6a0626bc8d862e5611d4b327a596fe79))
...
* **common:** CHECKOUT-4223 Check to make sure there are no unused locals and parameters ([6febd60](https://github.com/bigcommerce/checkout-js/commit/6febd60d4df5f68090688e565b96842e291d8a8a))
* **common:** CHECKOUT-4223 Ensure there is only one instance of `LanguageService` and it is created after application is mounted ([8221b5b](https://github.com/bigcommerce/checkout-js/commit/8221b5b7148489268b68fc4ae4795d2e6df1c465))
* **common:** CHECKOUT-4223 Re-export utility classes / functions ([53f391f](https://github.com/bigcommerce/checkout-js/commit/53f391fda5b357b9abeca6421911868a89399b30))
* **common:** CHECKOUT-4272 Add ability to pass mapper factory to injector HOC so it is possible to call memoized function inside mapper for each component instance ([cfc7a8f](https://github.com/bigcommerce/checkout-js/commit/cfc7a8f8e02ae4635919cee55c2b20dec5b64713))
* **common:** CHECKOUT-4272 Use bigcommerce/memoize package ([337b719](https://github.com/bigcommerce/checkout-js/commit/337b719395b89c1b735286e409085c0b01063142))
* **common:** CHECKOUT-4338 Fix circular dependencies of ES modules ([e28f98d](https://github.com/bigcommerce/checkout-js/commit/e28f98d8346164c92b3088972c34271ab3db76eb))
* **common:** CHECKOUT-4338 Include hash in file name so we can determine public path for IE11 more reliably ([e5a9c57](https://github.com/bigcommerce/checkout-js/commit/e5a9c5736f1b82b6f945a82bc81e3cf681c1b91d))
* **common:** CHECKOUT-4338 Move `BuildHooks` Webpack plugin to `scripts` folder ([54de46c](https://github.com/bigcommerce/checkout-js/commit/54de46c2653b9986608c639deac20a95ff6e77ac))
* **common:** CHECKOUT-4338 Re-enable modules concatenation ([1b79f2b](https://github.com/bigcommerce/checkout-js/commit/1b79f2bcc60e0a38c7ded6c4679db9ccb2bd9d95))
* **common:** CHECKOUT-4338 Stop importing internal modules ([ef9d34c](https://github.com/bigcommerce/checkout-js/commit/ef9d34c2829d137df64add76ca1ffacd90216585))
* **common:** CHECKOUT-4338 Use ESLint to help fix import / export issues ([a27769e](https://github.com/bigcommerce/checkout-js/commit/a27769e180b10db5765841b625a5c2fe86438a0b))
* **common:** CHECKOUT-4351 Enable React-specific ESLint rules ([ce56dd1](https://github.com/bigcommerce/checkout-js/commit/ce56dd1cd8427ff58fbd6db4fbbb8b3bbfd1805c))
* **common:** CHECKOUT-4352 Turn on `react/jsx-no-bind` rule ([ae10fdb](https://github.com/bigcommerce/checkout-js/commit/ae10fdba2a05daa8f5b0547d496f0a9d8ea34e17))
...
* **extension:** CHECKOUT-7635 Improve Command Handler Scalability ([#1432](https://github.com/bigcommerce/checkout-js/issues/1432)) ([cab01ac](https://github.com/bigcommerce/checkout-js/commit/cab01ac4f773575a2f7688ba37bf5f643cd33ef1))
...
* **payment:** CHECKOUT-4272 Use nested component instead of memoize ([a95cc2d](https://github.com/bigcommerce/checkout-js/commit/a95cc2d0a7085ab8f7aa66e49e07d43dc221d91a))
...
### [1.365.2](https://github.com/bigcommerce/checkout-js/compare/v1.365.1...v1.365.2) (2023-08-29)

### [1.365.1](https://github.com/bigcommerce/checkout-js/compare/v1.365.0...v1.365.1) (2023-08-29)
...
### [1.363.1](https://github.com/bigcommerce/checkout-js/compare/v1.363.0...v1.363.1) (2023-08-25)
...
## [1.361.0](https://github.com/bigcommerce/checkout-js/compare/v1.360.3...v1.361.0) (2023-08-23)
...
### [1.360.3](https://github.com/bigcommerce/checkout-js/compare/v1.360.2...v1.360.3) (2023-08-22)
...
### [1.359.1](https://github.com/bigcommerce/checkout-js/compare/v1.359.0...v1.359.1) (2023-08-21)
...
### [1.352.2](https://github.com/bigcommerce/checkout-js/compare/v1.352.1...v1.352.2) (2023-08-09)
...
## [1.338.0](https://github.com/bigcommerce/checkout-js/compare/v1.337.0...v1.338.0) (2023-07-05)
...
### [1.261.1](https://github.com/bigcommerce/checkout-js/compare/v1.261.0...v1.261.1) (2022-10-13)
...
### [1.247.2](https://github.com/bigcommerce/checkout-js/compare/v1.247.1...v1.247.2) (2022-08-19)
...
## [1.243.0](https://github.com/bigcommerce/checkout-js/compare/v1.242.1...v1.243.0) (2022-08-13)
...
### [1.232.6](https://github.com/bigcommerce/checkout-js/compare/v1.232.5...v1.232.6) (2022-07-18)
...
### [1.232.2](https://github.com/bigcommerce/checkout-js/compare/v1.232.1...v1.232.2) (2022-07-13)

### [1.232.1](https://github.com/bigcommerce/checkout-js/compare/v1.232.0...v1.232.1) (2022-07-12)

## [1.232.0](https://github.com/bigcommerce/checkout-js/compare/v1.231.2...v1.232.0) (2022-07-11)
...
### [1.231.2](https://github.com/bigcommerce/checkout-js/compare/v1.231.1...v1.231.2) (2022-07-08)
...
## [1.228.0](https://github.com/bigcommerce/checkout-js/compare/v1.227.2...v1.228.0) (2022-06-22)
...
### [1.227.2](https://github.com/bigcommerce/checkout-js/compare/v1.227.1...v1.227.2) (2022-06-22)

### [1.227.1](https://github.com/bigcommerce/checkout-js/compare/v1.227.0...v1.227.1) (2022-06-21)
...
## [1.219.0](https://github.com/bigcommerce/checkout-js/compare/v1.218.0...v1.219.0) (2022-05-30)
...
## [1.205.0](https://github.com/bigcommerce/checkout-js/compare/v1.204.2...v1.205.0) (2022-04-07)
...
### [1.200.4](https://github.com/bigcommerce/checkout-js/compare/v1.200.3...v1.200.4) (2022-03-29)
...
## [1.200.0](https://github.com/bigcommerce/checkout-js/compare/v1.199.0...v1.200.0) (2022-03-11)
...
### [1.195.2](https://github.com/bigcommerce/checkout-js/compare/v1.195.1...v1.195.2) (2022-02-10)
